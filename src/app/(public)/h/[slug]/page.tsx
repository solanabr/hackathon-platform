    ...
    <div>
      ...
      >
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0">
          <div
            className="morth animate-float-a absolute hidden bg-yellow sm:-left-32 sm:top-[60%] sm:block sm:h-[22rem] sm:w-[22rem] lg:-left-44 lg:top-[66%] lg:h-[30rem] lg:w-[30rem] xl:-left-28 2xl:-left-10 2xl:top-[62%] 2xl:h-[34rem] 2xl:w-[34rem]"
          ...
          />
          <div
            className="morth animate-float-b absolute hidden bg-emerald sm:-right-36 sm:-top-16 sm:block sm:h-[20rem] sm:w-[20rem] lg:-right-44 lg:-top-24 lg:h-[28rem] lg:w-[28rem] xl:-right-28 2xl:-right-10 2xl:-top-16 2xl:h-[34rem] 2xl:w-[34rem]"
