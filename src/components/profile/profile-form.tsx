    ...
    <form action={formAction} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          className="mt-1.5 w-full rounded-xl border border-green-dark/15 bg-surface-raised px-4 py-3 text-sm leading-relaxed outline-none transition-colors ease-entrada placeholder:text-muted/60 focus:border-emerald focus-visible:ring-2 focus-visible:ring-emerald/30"
        />
      </div>
      <div>
