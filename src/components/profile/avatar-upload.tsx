  ...
  return (
    <div className="shrink-0">
      ...
      >
        ...
        <span
          aria-hidden
          className="absolute inset-0 flex items-center justify-center rounded-2xl bg-green-dark/75 text-xs font-bold uppercase tracking-wide text-ink opacity-0 transition-opacity duration-(--dur-instant) ease-entrada group-hover:opacity-100 group-focus-visible:opacity-100"
        >
          {busy ? "..." : "Trocar"}
        </span>
      </button>
