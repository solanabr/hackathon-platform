...
const BASE =
  "w-full rounded-xl border border-white/10 bg-surface-raised px-4 py-3 text-ink placeholder:text-muted/60 focus:border-emerald focus:outline-none focus:ring-2 focus:ring-emerald/40 transition-colors";
