    ...
    <li className="rounded-2xl border border-green/15 bg-surface-raised p-5">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3 text-sm">
        ...
        <button
          ...
          onClick={remove}
          disabled={pending}
          className="text-muted underline-offset-4 hover:text-red-700 hover:underline disabled:opacity-50"
        >
          Remover
        </button>
      </div>
      ...
      {editing && (
        <div className="mt-4 rounded-2xl border border-green/15 bg-surface p-5">
