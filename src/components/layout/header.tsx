  ...
  return (
    <header className="sticky top-3 z-50 px-3 sm:top-4 sm:px-6">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-x-4 gap-y-2 rounded-2xl border-2 border-green-dark bg-green-dark px-4 py-3 shadow-[6px_6px_0_rgba(27,35,29,0.25)] sm:px-6">
        ...
        <nav className="flex items-center gap-4 text-sm font-semibold text-surface/80 sm:gap-5">
          {state ? (
            <>
              ...
              <form action="/api/auth/signout" method="post">
                <button
                  type="submit"
                  className="transition-colors duration-150 hover:text-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow focus-visible:ring-offset-2 focus-visible:ring-offset-green-dark"
                >
                  Sair
                </button>
              </form>
